...
"""Compile or check every CQ enhanced-SME (LegacySme) asynchronous G2S copy.
...
SmexMtx G2S + ``CQMtxLoadn`` teaching / correctness lives in
``examples/02-tiledCopy-iluvatar-cq.py`` (do not mix LegacySme and SmexMtx on
