...
"""CQ (ivcore30) MMA tile helpers: base tile + FeatureLongMtx presets.

``mma_tile`` selects the CQMma (M, N) enlargement; K is dtype-dependent and
unchanged by long-mtx (f16/bf16 K=16, s8 K=32).
"""
