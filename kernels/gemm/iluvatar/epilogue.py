...
"""Reusable Iluvatar GEMM epilogue helpers (MR today; CQ-capable layout).

Lives under ``kernels.gemm.iluvatar`` (not ``mr``) so store paths can be shared
across MR/CQ-style pipelines. Current helpers still use MR atom geometry.
