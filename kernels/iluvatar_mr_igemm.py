...
(see ``kernels.iluvatar_common.GemmLayout``). ``tn`` (both operands k-major) is
...
from kernels.iluvatar_mr_operand_copy import mr_g2s_sme_config, mr_gemm_g2s_issue_operands
from kernels.iluvatar_mr_s2r import mr_gemm_s2r_load_mma_k
