...
def plan_decode_launch(
    *,
    ...
    if use_simt_decode and max_context_len is not None:
        # ixinfer's single-sequence GQA policy plans in 32-token work units.
        # Keeping the same granularity avoids over-splitting 513/1025-token
        # decode steps into their 1024/2048 power-of-two capacity buckets.
