...
``flash_attn_kvcache_v5_decode.py`` constrains this builder to a 16-token HND page and
selects it automatically.  The KV-streaming loop mirrors how library's
