...
namespace mlir {
#define GEN_PASS_DEF_FLYTOCQCONVERSIONPASS
...
class FlyToCQConversionPass
    : public mlir::impl::FlyToCQConversionPassBase<FlyToCQConversionPass> {
public:
  using mlir::impl::FlyToCQConversionPassBase<
      FlyToCQConversionPass>::FlyToCQConversionPassBase;
  ...
  void runOnOperation() override {
    ...
    target.addLegalDialect<arith::ArithDialect, scf::SCFDialect, vector::VectorDialect,
                           ...
                           ROCDL::ROCDLDialect>();
    target.addIllegalDialect<fly::FlyDialect, fly_cq::FlyCQDialect>();
