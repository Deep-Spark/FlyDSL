...
FLYDSL_ILUVATAR_RUN_MR_ASYNC_CP="${FLYDSL_ILUVATAR_RUN_MR_ASYNC_CP:-0}"
FLYDSL_ILUVATAR_RUN_MR_EPILOGUE="${FLYDSL_ILUVATAR_RUN_MR_EPILOGUE:-0}"
FLYDSL_ILUVATAR_RUN_MR_HGEMM_STAGES="${FLYDSL_ILUVATAR_RUN_MR_HGEMM_STAGES:-0}"
FLYDSL_ILUVATAR_RUN_MR_MMA="${FLYDSL_ILUVATAR_RUN_MR_MMA:-0}"
FLYDSL_ILUVATAR_RUN_MR_S2R="${FLYDSL_ILUVATAR_RUN_MR_S2R:-0}"
FLYDSL_ILUVATAR_RUN_MR_S2R_MMA="${FLYDSL_ILUVATAR_RUN_MR_S2R_MMA:-0}"
...
FLYDSL_ILUVATAR_SMOKE_KERNEL=${FLYDSL_ILUVATAR_SMOKE_KERNEL}
FLYDSL_ILUVATAR_LAUNCH_KERNEL=${FLYDSL_ILUVATAR_LAUNCH_KERNEL}
FLYDSL_ILUVATAR_RUN_MR_ASYNC_CP=${FLYDSL_ILUVATAR_RUN_MR_ASYNC_CP}
FLYDSL_ILUVATAR_RUN_MR_EPILOGUE=${FLYDSL_ILUVATAR_RUN_MR_EPILOGUE}
FLYDSL_ILUVATAR_RUN_MR_HGEMM_STAGES=${FLYDSL_ILUVATAR_RUN_MR_HGEMM_STAGES}
FLYDSL_ILUVATAR_RUN_MR_MMA=${FLYDSL_ILUVATAR_RUN_MR_MMA}
FLYDSL_ILUVATAR_RUN_MR_S2R=${FLYDSL_ILUVATAR_RUN_MR_S2R}
FLYDSL_ILUVATAR_RUN_MR_S2R_MMA=${FLYDSL_ILUVATAR_RUN_MR_S2R_MMA}
...
docker_args=(
  ...
  -e FLYDSL_ILUVATAR_RUN_MR_ASYNC_CP="${FLYDSL_ILUVATAR_RUN_MR_ASYNC_CP}"
  -e FLYDSL_ILUVATAR_RUN_MR_EPILOGUE="${FLYDSL_ILUVATAR_RUN_MR_EPILOGUE}"
  -e FLYDSL_ILUVATAR_RUN_MR_HGEMM_STAGES="${FLYDSL_ILUVATAR_RUN_MR_HGEMM_STAGES}"
  -e FLYDSL_ILUVATAR_RUN_MR_MMA="${FLYDSL_ILUVATAR_RUN_MR_MMA}"
  -e FLYDSL_ILUVATAR_RUN_MR_S2R="${FLYDSL_ILUVATAR_RUN_MR_S2R}"
  -e FLYDSL_ILUVATAR_RUN_MR_S2R_MMA="${FLYDSL_ILUVATAR_RUN_MR_S2R_MMA}"
