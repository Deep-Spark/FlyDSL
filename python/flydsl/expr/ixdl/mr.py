...
``sme_swizzle`` value selecting the SME shared-memory swizzle state; the element
dtype and ``Major::K/MN`` axis are orthogonal and are carried elsewhere
(``fly.copy_atom<..., elemBits>`` / the kernel layout factory), not by this
parameter.
"""
