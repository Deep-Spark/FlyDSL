...
def _collect_closure_scalar_vals(func, visited_ids: Optional[Set[int]] = None) -> List[str]:
    ...
    for name, cell in zip(func.__code__.co_freevars, func.__closure__):
        ...
        if isinstance(val, (int, float, bool, str, type(None), tuple)):
            ...
            # and are not callables, so record them here. Use module.qualname,
            # not repr: a metaclass __repr__ can embed an address and miss the
            # disk cache across processes.
