...
func.func @add_offset_global_b32(%p: !fly.ptr<f32, global>, %dyn: i32) {
...
// CHECK: %[[BYTES:.*]] = arith.muli %[[IDX]], %[[EB]] : i32
// CHECK: llvm.getelementptr %[[P]][%[[BYTES]]] : (!llvm.ptr<1>, i32) -> !llvm.ptr<1>, i8
func.func @add_offset_global_b16(%p: !fly.ptr<f16, global>, %dyn: i32) {
  %off = fly.make_int_tuple(%dyn) : (i32) -> !fly.int_tuple<?>
  %p2 = fly.add_offset(%p, %off)
...
func.func @add_offset_global_b8(%p: !fly.ptr<i8, global>, %dyn: i32) {
  %off = fly.make_int_tuple(%dyn) : (i32) -> !fly.int_tuple<?>
  %p2 = fly.add_offset(%p, %off)
...
func.func @add_offset_shared_b32(%p: !fly.ptr<f32, shared>, %dyn: i32) {
  %off = fly.make_int_tuple(%dyn) : (i32) -> !fly.int_tuple<?>
  %p2 = fly.add_offset(%p, %off)
